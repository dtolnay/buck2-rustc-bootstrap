...
rust_bootstrap_binary(
    ...
    srcs = ["rust/src/tools/clippy/src/main.rs"],
    crate = "cargo_clippy",
...
rust_bootstrap_binary(
    ...
    srcs = ["rust/src/tools/clippy/src/driver.rs"],
    crate = "clippy_driver",
...
rust_bootstrap_library(
    ...
    srcs = ["rust/compiler/rustc_arena/src/lib.rs"],
    crate = "rustc_arena",
...
rust_bootstrap_library(
    ...
    srcs = ["rust/compiler/rustc_graphviz/src/lib.rs"],
...
rust_bootstrap_library(
    ...
    srcs = ["rust/compiler/rustc_parse_format/src/lib.rs"],
...
rust_bootstrap_binary(
    ...
    srcs = ["rust/src/librustdoc/build.rs"],
    crate = "build_script_build",
...
rust_bootstrap_library(
    ...
    srcs = ["rust/src/rustdoc-json-types/lib.rs"],
...
rust_bootstrap_binary(
    ...
    srcs = ["rust/library/std/build.rs"],
    crate = "build_script_build",
