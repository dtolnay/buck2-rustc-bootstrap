...
rust_bootstrap_alias(
    ...
    platforms = [
        "linux-arm64-library",
        "linux-riscv64-library",
        "linux-x86_64-library",
        "macos-arm64-library",
        "macos-x86_64-library",
        "windows-gnu-library",
        "windows-msvc-library",
    ],
    visibility = ["PUBLIC"],
)
...
rust_bootstrap_alias(
    ...
    platforms = [
        "linux-arm64-compiler",
        "linux-riscv64-compiler",
        "linux-x86_64-compiler",
        "macos-arm64-compiler",
        "macos-x86_64-compiler",
        "windows-gnu-compiler",
...
rust_bootstrap_library(
    name = "jiff-0.2",
    srcs = [":jiff-0.2.31.crate"],
    crate = "jiff",
    crate_root = "jiff-0.2.31.crate/src/lib.rs",
    edition = "2021",
    features = [
        "alloc",
        "std",
