...
rust_bootstrap_library(
    name = "rand-0.8",
    srcs = [":rand-0.8.7.crate"],
    crate = "rand",
    crate_root = "rand-0.8.7.crate/src/lib.rs",
    edition = "2018",
    features = [
        "alloc",
        "default",
...
crate_download(
    name = "rustc-literal-escaper-0.0.7.crate",
...
rust_bootstrap_library(
    name = "rustc-literal-escaper-0.0.7",
    srcs = [":rustc-literal-escaper-0.0.7.crate"],
    crate = "rustc_literal_escaper",
    crate_root = "rustc-literal-escaper-0.0.7.crate/src/lib.rs",
    edition = "2021",
    platform = {
        "linux-arm64-library": dict(
...
rust_bootstrap_library(
    ...
    srcs = [
        ...
        "rust/compiler/rustc_attr_parsing/src/attributes/diagnostic/check_cfg.rs",
        ...
        "rust/compiler/rustc_attr_parsing/src/attributes/diagnostic/on_unmatch_args.rs",
        ...
        "rust/compiler/rustc_attr_parsing/src/errors.rs",
...
rust_bootstrap_library(
    ...
    srcs = [
        ...
        "rust/compiler/rustc_errors/src/lints.rs",
...
rust_bootstrap_library(
    ...
    srcs = [
        ...
        "rust/compiler/rustc_hir_analysis/src/errors/remove_or_use_generic.rs",
...
rust_bootstrap_library(
    ...
    visibility = [],
    deps = [":rustc-literal-escaper-0.0.7"],
)
