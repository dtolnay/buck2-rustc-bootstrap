...
rust_bootstrap_alias(
    ...
    actual = ":clippy-0.1.93-cargo-clippy",
    visibility = ["PUBLIC"],
)

rust_bootstrap_binary(
    name = "clippy-0.1.93-cargo-clippy",
    srcs = [
    ...
    deps = [
        ":anstream-0.6.21",
        ":clippy_config-0.1.93",
        ":clippy_lints-0.1.93",
        ":clippy_utils-0.1.93",
        ":color-print-0.3.7",
        ":declare_clippy_lint-0.1.93",
        ":rustc_driver-0.0.0",
...
rust_bootstrap_alias(
    ...
    actual = ":clippy-0.1.93-clippy-driver",
    visibility = ["PUBLIC"],
)

rust_bootstrap_binary(
    name = "clippy-0.1.93-clippy-driver",
    srcs = [
        "rust/src/tools/clippy/src/driver.rs",
        "rust/src/tools/clippy/src/main.rs",
    ],
...
rust_bootstrap_library(
    name = "declare_clippy_lint-0.1.93",
...
rust_bootstrap_library(
    ...
    srcs = [
        ...
        "rust/library/std/src/sys/anonymous_pipe/motor.rs",
        ...
        "rust/library/std/src/sys/pal/motor/pipe.rs",
...
crate_download(
    name = "stringdex-0.0.3.crate",
    sha256 = "556a6126952cb2f5150057c98a77cc6c771027dea2825bf7fa03d3d638b0a4f8",
    strip_prefix = "stringdex-0.0.3",
    urls = ["https://static.crates.io/crates/stringdex/0.0.3/download"],
    visibility = [],
)

rust_bootstrap_library(
    name = "stringdex-0.0.3",
    srcs = [":stringdex-0.0.3.crate"],
    crate = "stringdex",
    crate_root = "stringdex-0.0.3.crate/src/lib.rs",
    edition = "2024",
    visibility = [],
    deps = [":stacker-0.1.21"],
)
